...
<div align="right">
    <ul class="actionButtons">
        <li><a href="#" onclick="postForm('csv_export',null,null);return false;"><img src="<?php echo SHOPKEEPER_PATH; ?>style/default/img/layout_go.png" alt="">&nbsp; Простой экспорт в CSV</a></li>
...
<!-- 
    Добавляем в конце свою кнопку, которая шлет запрос на файл модуля. Там творится вся магия.
 -->
<style>
  input[name=order]{
...
<form  action="/assets/modules/export_orders_shk/export_orders_shk.php" method="POST">
  <input name="order" type="submit" value="Детализированный экспорт в CSV">
</form>
